...
VALUES (
    ...
    (
        'staff',
        '8d969eef6ecad3c29a3a873fba6aa3285c080e8ad31a9ef313c52f53f7f0df9c',
        'Nhân viên kho',
        'Staff'
    );
...
VALUES (
        'Điện thoại & Phụ kiện',
        'Điện thoại thông minh, phụ kiện, sạc, cáp, ốp lưng, kính cường lực'
    ),
    (
        'Máy tính & Laptop',
        'Máy tính xách tay, máy tính để bàn, thiết bị ngoại vi, màn hình, bàn phím, chuột'
    ),
    (
        'Thiết bị gia dụng',
        'Tủ lạnh, máy giặt, máy hút bụi, nồi chiên không dầu, máy lọc không khí'
    ),
    (
        'Thời trang Nam',
        'Áo sơ mi, quần âu, giày da, thắt lưng, đồng hồ, phụ kiện thời trang nam'
    ),
    (
        'Thời trang Nữ',
        'Đầm, áo khoác, quần tây, giày cao gót, túi xách, kính mát, phụ kiện nữ'
    ),
    (
        'Mỹ phẩm & Làm đẹp',
        'Son môi, nước hoa, kem dưỡng, máy rửa mặt, bộ trang điểm chuyên nghiệp'
    ),
    (
        'Sách & Văn phòng phẩm',
        'Sách, truyện, bút ký, máy tính cầm tay, sổ tay, bàn cắt giấy'
    ),
    (
        'Thể thao & Du lịch',
        'Máy chạy bộ, xe đạp, lều cắm trại, vợt tennis, vali, ba lô du lịch'
    ),
    (
        'Đồ chơi & Mẹ bé',
        'Đồ chơi LEGO, xe đẩy em bé, máy hút sữa, ghế ngồi trẻ em, nhà banh'
    ),
    (
        'Ô tô & Xe máy',
        'Xe máy, mũ bảo hiểm, lốp xe, camera hành trình, phụ kiện ô tô'
    );
...
VALUES (
    ...
    (
        'Bộ trang điểm chuyên nghiệp MAC',
        6,
        8000000,
        999,
        5,
    ...
    (
        'Bộ LEGO Technic Bugatti Chiron',
        9,
        10000000,
        999,
        2,
    ...
    (
        'Camera hành trình Vietmap SpeedMap',
        10,
        5000000,
        999,
        10,
